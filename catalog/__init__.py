...
CLIENT_ID = json.loads(
    open('/var/www/FlaskApp/catalog/g_client_secrets.json', 'r').read())['web']['client_id']
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/FlaskApp/catalog/g_client_secrets.json', scope='')
...
def newMenuItem(restaurant_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        ...
        your own restaurant in order to add items.');}</script> \
        <body onload='myFunction()''>"
    if request.method == 'POST':
        newItem = MenuItem(
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if login_session['user_id'] != restaurant.user_id:
        return "<script>function myFunction() {alert('You are not \
        authorized to edit menu items to this restaurant. Please create \
        your own restaurant in order to edit items.');}</script> \
        <body onload='myFunction()''>"
    if request.method == 'POST':
        if request.form['name']:
